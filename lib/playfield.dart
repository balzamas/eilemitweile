...
List<Field> createFields()
{
    ...
    home_field.number = 0;
    home_field.position = Vector2(-100,-100);
    ...
    for(var i = 9; i < 17; i++){
      ...
      Field field = Field(fieldst: state);
      field.position = Vector2((console + (pos*fieldHeight)),(9 * fieldHeight ));
      field.angle = 1.57;
    ...
    fieldHeadBench1.position = Vector2(console + fieldHeight,(9*fieldHeight) + fieldWidth);
    ...
    for(var i = 18; i < 26; i++){
      ...
      Field field = Field(fieldst: state);
      field.position = Vector2((console + (pos*fieldHeight)),(9*fieldHeight + 2*fieldWidth));
      field.angle = 1.57;
      field.isRotated = true;
      field.number = i;
      pos = pos+1;
    ...
    for(var i = 26; i < 34; i++){
      ...
      Field field = Field(fieldst: state);
      field.position = Vector2((console + (8*fieldHeight)),(8 * fieldHeight + 3*fieldWidth + pos*fieldHeight));
      field.number = i;
      pos = pos+1;
      fields.add(field);
    }
    ...
    fieldHeadBench2.position = Vector2((console + (8*fieldHeight) + fieldWidth),(8 * fieldHeight + 3*fieldWidth + 8*fieldHeight));
    ...
    for(var i = 35; i < 43; i++){
      ...
      Field field = Field(fieldst: state);
      field.position = Vector2((console + (8*fieldHeight) + (2*fieldWidth)),(8 * fieldHeight + 3*fieldWidth + pos*fieldHeight));
      field.number = i;
      pos = pos-1;
      fields.add(field);
    }
    ...
    for(var i = 43; i < 51; i++){
      ...
      Field field = Field(fieldst: state);
      field.position = Vector2((console + (8*fieldHeight) + (3*fieldWidth) + (pos*fieldHeight) ),(9*fieldHeight + 2*fieldWidth));
      field.angle = 1.57;
      field.isRotated = true;
      field.number = i;
      pos = pos+1;
    ...
    fieldHeadBench3.position = Vector2((console + (8*fieldHeight) + (3*fieldWidth) + (8*fieldHeight) ),(9*fieldHeight + 1*fieldWidth));
    ...
    for(var i = 52; i < 60; i++){
      ...
      Field field = Field(fieldst: state);
      field.position = Vector2((console + (8*fieldHeight) + (3*fieldWidth) + (pos*fieldHeight)),(9*fieldHeight));
      field.angle = 1.57;
      field.isRotated = true;
      field.number = i;
      pos = pos-1;
    ...
    for(var i = 60; i < 68; i++){
      ...
      Field field = Field(fieldst: state);
      field.position = Vector2((console + (8*fieldHeight) + (2*fieldWidth)),(pos*fieldHeight));
      field.number = i;
      pos = pos-1;
      fields.add(field);
    }
    ...
    fieldHeadBench4.position = Vector2((console + (8*fieldHeight) + fieldWidth),fieldHeight);
    ...
    for(var i = 69; i < 76; i++){
      ...
      field.number = i;
      field.position = Vector2(-100,-100);
      fields.add(field);
    }

    Field fieldHeaven = Field(fieldst: FieldState.heaven);
    fieldHeaven.position = Vector2(-100,-100);
